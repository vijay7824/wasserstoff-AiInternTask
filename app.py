...
#     st.markdown('''
#     ## About
#     This app an LLM-powered chatbot build using:
...
#     st.write('Made with Vijay')

# def main():
#     st.write("hhhhhh ghfhfghfgh dgtrtyrt  werer we rwerwrwrw")
...
#         text_split = RecursiveCharacterTextSplitter(chunk_size = 1024, chunk_overlap=200, length_function = len)
